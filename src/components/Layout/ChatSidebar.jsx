...
const ChatSidebar = ({
  ...
  const ConversationItem = ({ chat }) => (
    <div
      ...
      <MessageSquare
        size={18}
        className="text-gray-500 dark:text-gray-400 shrink-0 ml-1"
      />
      ...
      {menuChatId === chat.id && (
        <div className="chat-menu-container absolute right-0 top-full mt-1 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden text-sm animate-in fade-in zoom-in-95 duration-100">
          {/* <button
            ...
            className="w-full flex items-center gap-2 px-4 py-2.5 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 text-left">
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-4 py-2.5 hover:bg-red-50 dark:hover:bg-red-900/20 text-red-600 dark:text-red-400 text-left">
  ...
  const ProfileTrigger = () => (
    <button
      ...
      } rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors group`}>
      <div className="flex items-center gap-3">
        ...
        {!isCollapsed && (
          <div className="text-left">
            <div className="text-sm font-semibold text-gray-700 dark:text-gray-200 leading-none">
              {user?.name || "John Doe"}
            </div>
      ...
      <aside
        ...
        {!isCollapsed && (
          <>
            ...
            <div className="p-3 space-y-4">
              ...
              <div className="flex items-center justify-between px-2 pt-1">
                <span className="font-bold text-lg tracking-tight flex items-center gap-2">
                  <div className="w-6 h-6 rounded-md bg-black dark:bg-white text-white dark:text-black flex items-center justify-center text-xs">
                    H
                  </div>
                  Horizon
                </span>
              ...
              <div className="relative group px-1">
                <Search
                  size={14}
                  className="absolute left-4 top-2.5 text-gray-500 group-focus-within:text-gray-800 dark:group-focus-within:text-gray-200 transition-colors"
                />
                <input
                  type="text"
                  placeholder="Search..."
            ...
            <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-none pb-2">
              <h3 className="px-5 text-xs font-semibold text-gray-400 mb-2 mt-2 uppercase tracking-wide">
                Explore
              </h3>
              <div className="mb-4">
                <NavItem
                  ...
                  icon={LayoutGrid}
                  label="My Dashboard"
                  active={location.pathname === "/new-home"}
                />
                <NavItem
                  to="/assess"
                  icon={BookOpen}
                  label="Assessment"
                  active={location.pathname === "/assess"}
                />
                ...
                <div className="mx-2">
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition-colors group text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-200 ${
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (role === "Software Engineer")
                              navigate("/roadmaps/software-engineer");
                            else if (role === "Data Engineer")
                              navigate("/roadmaps/data-engineer");
                            else if (role === "Data Analyst")
                              navigate("/roadmaps/data-analyst");
                            else if (role === "AI Engineer")
                              navigate("/roadmaps/ai-ml");
              ...
              {pinnedChats.length > 0 && (
                <div className="mb-4">
                  <h3 className="px-5 text-xs font-semibold text-gray-400 mb-2 uppercase tracking-wide">
                    Pinned
                  </h3>
        ...
        {isCollapsed && (
          <div className="flex-1 flex flex-col items-center pt-4 pb-2 space-y-6">
            ...
            <div
              className="w-8 h-8 bg-black dark:bg-white rounded-lg flex items-center justify-center text-white dark:text-black font-bold mb-4 cursor-pointer"
            ...
            <div className="flex flex-col gap-4 w-full px-2">
              <button
                onClick={handleExpand}
                className="p-3 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-800 text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors flex justify-center"
                title="Explore">
                <LayoutGrid size={22} />
              </button>
            </div>
        ...
        <div
          className="p-2 border-t border-gray-200 dark:border-white/10 relative"
          ref={profileMenuRef}>
          <ProfileTrigger />
            ...
            <>
              <div
                className={`absolute bottom-full ${
                  isCollapsed ? "left-2 mb-2 w-64" : "left-2 right-2 mb-2"
                } bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden animate-in fade-in zoom-in-95 slide-in-from-bottom-2`}>
                {/* Dropdown Header */}
                ...
                <div className="p-1.5 space-y-0.5">
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg text-sm text-gray-700 dark:text-gray-200 transition-colors">
                  ...
                  <button
                    onClick={logout}
                    className="w-full flex items-center gap-3 px-3 py-2.5 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg text-sm text-red-600 dark:text-red-400 transition-colors">
