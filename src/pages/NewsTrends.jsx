      ...
      try {
        if (activeTab === "news") {
          ...
          const response = await fetch(
            `${API_URL}/api/news?category=technology`
          );
                ...
                <div
                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    ...
                    <a
                      ...
                      className="p-2 text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors">
