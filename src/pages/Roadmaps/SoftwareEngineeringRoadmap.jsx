...
import { softwareEngineeringData as initialData } from '../../data/softwareEngineeringData';
...
const calculateRoadmapState = (currentPhases) => {
    ...
    for (let i = 0; i < phases.length; i++) {
        ...
        // If the phase is unlocked, its skills should be unlockable
        if (phase.status !== 'locked') {
                ...
                >
                    <div>
                        ...
                        <p className="text-lg text-gray-500 dark:text-gray-400">
                            Your comprehensive guide to becoming a Software Engineer.
                        </p>
                    </div>
